...
DATASET_PATH = '../../../datasets/quant.txt'
DEFAULT_RKNN_PATH = '../model/yolov8n_pose_fp.rknn'
DEFAULT_QUANT = True
    ...
    if platform in ["rv1109","rv1126","rk1808"] :
        ...
        if do_quant:
            rknn.hybrid_quantization_step1(
                ...
                # custom_hybrid=[['/model.22/cv4.0/cv4.0.0/act/Mul_output_0','439'],
                #                 ['/model.22/cv4.1/cv4.1.0/act/Mul_output_0','439'],
                #                 ['/model.22/cv4.2/cv4.2.0/act/Mul_output_0','439']]
            )
            ...
            list_temp_file.append(model_input)
            list_temp_file.append(data_input)
            list_temp_file.append(model_quantization_cfg)
        else:
