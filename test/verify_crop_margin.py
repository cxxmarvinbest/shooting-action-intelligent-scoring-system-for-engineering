...
用法（RK3588 板端，需 rknn-toolkit-lite2 与 rknn_yolov8 .so 已部署）：
  python test/verify_crop_margin.py                                  # 默认 50 帧、4 档
  python test/verify_crop_margin.py --video /path/to/far_field.mp4   # 指定远场视频
  python test/verify_crop_margin.py --frames 50 --margins 0,10,20,30
