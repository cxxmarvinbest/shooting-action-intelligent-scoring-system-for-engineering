...
用法（RK3588 板端，需 rknn-toolkit-lite2 与 rknn_yolov8 .so 已部署）：
  python test/regression/test_t2_5_regression.py --video test/test_videos/left_rtsp.mp4 --frames 50   # 层面 A
  python test/regression/test_t2_5_regression.py --video test/test_videos/left_rtsp.mp4 --full        # 层面 A+B
